 ...
 * @endcode
 *
 * @param list - The list for which to set the iterator and return the first element.
 * @return
 ...
 *
 * @param list - The list for which to set the iterator and return the last element.
 * @return
 * NULL if a NULL pointer was sent or the list is empty.
 * Otherwise, the last element of the list
 */
