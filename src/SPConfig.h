...
#define INVALID_LINE_ERROR(x,y) \
(printf("File: %s\nLine: %d\nMessage: Invalid configuration line\n",x,y))

#define CONSTRAINT_ERROR(x,y) \
(printf("File: %s\nLine: %d\nMessage: Invalid value - constraint not met\n",x,y))

#define VALUE_NOT_SET_ERROR(x,y,z) \
 ...
 * i.e the value of spNumOfFeatures.
 *
 * @param config - the configuration structure
 * @assert msg != NULL
 * @param msg - pointer in which the msg returned by the function is stored
...
/*
 * Returns the number of of similar images to be found.
...
/**
 * Returns the max size of the SPBPriorityQueue. i.e the value of spKNN.
 *
 * @param config - the configuration structure
 * @assert msg != NULL
 * @param msg - pointer in which the msg returned by the function is stored
...
/**
 * Given an index 'index' the function stores in featFilePath the full path of the
 * feat file.
 *
 * @param featFilePath - an address to store the result in.
 * @param config - the configuration structure
 * @param index - the index of the image.
 *
 * @return
...
/*
 * Returns the level of the Logger (an int)
 *
 * @param config - the configuration structure
 * @assert msg != NULL
 * @param msg - pointer in which the msg returned by the function is stored
 ...
 * @assert msg != NULL
 * @param msg - pointer in which the msg returned by the function is stored
 * @return string with file-name, NULL otherwise.
 *
 * - SP_CONFIG_INVALID_ARGUMENT - if config == NULL
 * - SP_CONFIG_SUCCESS - in case of success
 */
 ...
 * @assert msg != NULL
 * @param msg - pointer in which the msg returned by the function is stored
 * @return on success RANDOM || MAX_SPREAD || INCREMENTAL, NULL otherwise.
 *
 * - SP_CONFIG_INVALID_ARGUMENT - if config == NULL
 * - SP_CONFIG_SUCCESS - in case of success
 */
