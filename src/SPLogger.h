 ...
 * spLoggerPrintError   - Prints error messages at levels {Error, Warning, Info, Debug}
...
/**
 * Creates a logger. Same as the one above just gets the logger level as an Integer.
 */
